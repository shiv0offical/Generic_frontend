...
function EmployeePunchDetails() {
  ...
  const fetchData = async () => {
    ...
    if (res.success) {
      console.log(
        "🚀 ~ EmployeePunchDetails.jsx:65 ~ fetchData ~ res:",
        res.data
      );

      const formatData = res.data.employees.map((item, idx) => {
        console.log(
          "🚀 ~ EmployeePunchDetails.jsx:71 ~ fetchData ~ item:",
          item
        );
        return {
          id: idx + 1,
  ...
  console.log(
    "🚀 ~ EmployeePunchDetails.jsx:58 ~ EmployeePunchDetails ~ punhcData:",
    punhcData
  );
  ...
  return (
    <div className="w-full h-full p-2">
      <div className="bg-white rounded-sm border-t-3 border-[#07163d] mt-4">
        <div className="p-4">
          <h3 className="text-2xl font-bold mb-4 text-[#07163d]">
            Bus Details
          </h3>
        ...
        <div className="flex justify-between items-center p-4">
          <h2 className="text-2xl font-bold mb-4 text-[#07163d]">
