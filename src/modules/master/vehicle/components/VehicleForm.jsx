  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      if (rowData) {
        // Update
        await dispatch(
          updateVehicle({ id: rowData.actual_id, payload })
        ).unwrap();
      } else {
        // Create
      ...
      // Refetch vehicle list after create/update
      await dispatch(fetchVehicles({ page: 1, limit: 10 }));
              ...
              <div className="grid grid-col-1 md:grid-cols-2 gap-3">
                <div>
                  ...
                  <Autocomplete
                    ...
                    value={
                      driverOptions.find(
                        (opt) => opt.value === formVal.selectedDriver
                      ) || null
                    }
